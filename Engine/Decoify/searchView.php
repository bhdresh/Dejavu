...
<?php include 'template/main-sidebar.php';?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <?php
      if($_GET["decoy_type"] == 2)
      {
      ?>
        <a href="search.php?decoy_type=1">
          <button type="button" class="btn btn-primary btn-sm">
           Show Internal Decoy Logs        
          </button>
        </a>
      <?php
      }else
      {
      ?>
      <a href="search.php?decoy_type=2">
          <button type="button" class="btn btn-primary btn-sm" >
           Show External Decoy Logs        
          </button>
        </a>
      <?php
      }
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                      ...
                      ?>
                        <tr role="row" class="odd">
                          ...
                          <td class=""><?= dataFilter($event[$key]['EventType'])?></td>
