        ...
        <div class="col-xs-12">
          <div class="box">
                  ...
                  <div class="box-body">
                    <table id="example1" class="table table-bordered table-striped">
                      ...
                      <tr>
                        ...
                        <th>Service Deployed</th>
                        <th>Event Type</th>
                        <th>Decoy IP</th>
                        <th>Attacker IP</th>
                        <th class="sorting_desc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Timestamp: activate to sort column ascending" aria-sort="descending">Timestamp</th>
                      </tr>
                      </thead>
                      <tbody>
                      <?php if(!empty($event)){
                      ...
                      ?>
                        <tr role="row" class="odd">
                          ...
                          <td class=""><?= dataFilter($event[$key]['Service_Name'])?></td>
                          <td class=""><?= dataFilter($event[$key]['EventType'])?>
                         <?php if( $event[$key]['pcap_filename'] != '') {?>
                          <a href="download_evidence.php?filename=<?= dataFilter($event[$key]['pcap_filename'])?>">
                                <img src="images/pcap.png" height="25px" width="25px">
                          </a>
                          <?php 
                          }
                          if( $event[$key]['video_filename'] != '') {?>
			...
			<?php if( $event[$key]['msg_filename'] != '') {?>
                          ...
                          <td class="" ><?= dataFilter($event[$key]['TimeStamp'])?></td>
                        </tr>
