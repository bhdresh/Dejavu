...
<div class="login-box">
  ...
  ?>
    ...
    <div style="display: none;" id="smtp_setup">
    <p class="login-box-msg"><b>SMTP Setup</b></p>

      <div class="form-group has-feedback">
        <input type="text" name="smtp_hostname" class="form-control" placeholder="SMTP Server Name/IP (Optional)">
        <span class="glyphicon fa  fa-globe form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="text" name="smtp_username" class="form-control" placeholder="SMTP Username (Optional)">
        <span class="glyphicon fa fa-user-secret form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" name="smtp_password" class="form-control" placeholder="SMTP Password (Optional)">
        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
      </div>
      ...
      <div class="row">
        <div class="col-xs-8">
         <button type="button" class="btn btn-block btn-info btn-xs" id="config_button">Configure Management Interface </button>
          <button type="button" class="btn btn-block btn-info btn-xs" id="smtp_button">SMTP Setup</button>
        </div>
        <!-- /.col -->
        <div class="col-xs-4">
